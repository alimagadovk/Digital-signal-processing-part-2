...
% Синтезируем фильтр из предыдущего задания
h = zeros(1,M + 1);
j = 0:M;
for k = 0:M
...
% Синтезируем фильтр I-го типа с наилучшим равномерным приближением KD и
% M = 6
M = 6;
...
%line([0.5*pi pi], [-ds -ds], 'Color', 'm')
legend('АЧХ K(w)','АЧХ K2(w)','АЧХ KD(w)','1 ± delta_p; delta_s');
